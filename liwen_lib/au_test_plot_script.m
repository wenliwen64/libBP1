...
figure;
plot(test_point_x, test_point_y, 'd', 'MarkerFaceColor', 'b');

% Bp data point
for i = 1:numel(test_point_x)
    filename = ['logfile_autest_' num2str(test_point_ind_x(i)) '_' num2str(test_point_ind_y(i)) '.dat'];
...
hold on;
plot(bp_point_x, bp_point_y, 'd',  'MarkerFaceColor', 'm');   
