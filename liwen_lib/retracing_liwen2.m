function output = retracing_liwen2(input) % (lat, lon) tuple
...
%     [loc_new_grid, timeshift] = retracing_liwen([0, 60], [0, 100], 20)
     ...
     output_actual = raytracing_liwen2(input_actual);
     
     input_flat.ini_point_r = ini_point_r;
     input_flat.ini_vec = -ini_vec;
     ...
     output_flat = raytracing_liwen2(input_flat);
