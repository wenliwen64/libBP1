function [loc_third_point, refracted_vec0] = raytracing_liwen_downward(ini_point, ini_vec, v0_point, moho_norm_vec, third_layer_depth)
    ...
    n_index = 6.2 / 8.6;
    moho_norm_flat_vec = [0, 0, -1];  %downward
    ...
    %surface_point = [0, 0, 0];
    surface_point = [0, 0, -third_layer_depth];
    ...
    surface_zz = -third_layer_depth * ones(size(xx, 1), size(xx, 2));
    ...
    loc_third_point = [I0_2(1), I0_2(2), -third_layer_depth];
