...
figure(5);
      ...
      subplot(3,1,kkk);
         if kkk==1
        [C,H]=contourf(lat2/1e3, lon2/1e3, MM5,[0:25: 600])%1/20*[0 500 1000 1500 2000 2500 3000 3500 4000 4500 5000 5500 6000  7000  8000 9000 10000 11000  12000  13000 14000  16000  18000 20000 22000]);%[50 100 300 400 500 600 700 800 900 1000 1200 1500 2000 2500 3000 ]
       clabel(C,H,'fontsize',10,'color','r','rotation',0)
       set(H,'edgecolor','none');
       title(['d=' num2str(dd/1000) 'km']);
       xlabel('(km) distance of the source along the fault plane');
       ...
       colorbar;
         caxis([0 600 ]);
            ...
            if kkk==2
        [C,H]=contourf(lat2/1e3, lon2/1e3, MM5,[0:25: 600]);%*[0 500 1000 1500 2000 2500 3000 3500 4000 4500 5000 5500 6000  7000  8000 9000 10000 11000  12000  13000 14000  16000  18000 20000 22000]);%[50 100 300 400 500 600 700 800 900 1000 1200 1500 2000 2500 3000 ]
       set(H,'edgecolor','none');
        clabel(C,H,'fontsize',10,'color','r','rotation',0)
      title(['d=' num2str(dd/1000) 'km']);
       xlabel('(km) distance of the source along the fault plane');
