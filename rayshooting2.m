...
%I0S = [19.5:0.02:19.6];
I0S =10:0.2:12.5;         % initial angles, in degrees
XSTA = 0; ZSTA = 0;        % initial point
%ZEND = 0;                % vertical position of final point
XEND = 30e3;                % horizontal position of final point
...
figure(3);
        ...
        subplot(1,3,1)
        plot(ccc/1e3,xxxx/1e3,'LineWidth',2);
...
plot(0,0,'bv','MarkerSize',12);
title('illustration of determination of errors using ray theory');
       xlabel('(km) distance');
       ylabel('(km) depth')
xlim([-5 40])
ylim([-20 5])   
