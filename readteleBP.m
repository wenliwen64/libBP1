...
opr.sr=10;
ret=readAllSac('/Users/lsmeng/wk/matlab/bp/nchile/nchile78/data/',opr);
...
save('nchile','ret');
%  load HonshuORF1;
 load ~/wk/matlab/formalfunc/ptimes;
...
for i=1:n
     ...
     ret.xori(i,:)=ret.xori(i,:)/std(ret.xori(i,10*ret.sr:400*ret.sr));
end
% %%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% a=[];
